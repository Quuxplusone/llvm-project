...
constexpr unsigned char a[] = {
  #embed "Inputs/embed-100bytes.bin"
};
static_assert(std_equal(a, expected, 100));

constexpr unsigned char b[] = {
  #embed "Inputs/embed-100bytes.bin" limit(42)
};
static_assert(std_equal(b, expected, 42));

constexpr unsigned char c[] = {
  #embed "Inputs/embed-100bytes.bin" limit(100)
};
static_assert(std_equal(c, expected, 100));

constexpr unsigned char d[] = {
  #embed "Inputs/embed-100bytes.bin" limit(107)
};
...
static_assert(std_equal(ai, expected, 100));

constexpr int bi[] = {
  #embed "Inputs/embed-100bytes.bin" limit(42)
};
static_assert(std_equal(bi, expected, 42));

constexpr int ci[] = {
  #embed "Inputs/embed-100bytes.bin" limit(100)
};
static_assert(std_equal(ci, expected, 100));

constexpr int di[] = {
  #embed "Inputs/embed-100bytes.bin" limit(107)
};
static_assert(std_equal(di, expected, 100));

static_assert(is_empty_arg_list(
  #embed "Inputs/embed-empty.bin"
));

static_assert(is_empty_arg_list(
  #embed "Inputs/embed-empty.bin" limit(0)
));

static_assert(is_empty_arg_list(
  #embed "Inputs/embed-100bytes.bin" limit(0)
));
