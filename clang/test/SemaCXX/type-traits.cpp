...
// static_assert(!__is_pod(NonPODUnion), "");
  ...
  (void)__is_pod(AnIncompleteType); // expected-error {{incomplete type}}
  (void)__is_pod(AnIncompleteType[]); // expected-error {{incomplete type}}
  (void)__is_pod(AnIncompleteType[1]); // expected-error {{incomplete type}}
}
...
//  static_assert(!__is_empty(DerivesVirt), "");
  ...
  (void)__is_empty(AnIncompleteType); // expected-error {{incomplete type}}
...
void is_aggregate()
{
  ...
  (void)__is_aggregate(AnIncompleteType); // expected-error {{incomplete type}}
  (void)__is_aggregate(IncompleteUnion); // expected-error {{incomplete type}}
...
void is_trivial2()
{
  ...
  (void)__is_trivial(AnIncompleteType); // expected-error {{incomplete type}}
  (void)__is_trivial(AnIncompleteType[]); // expected-error {{incomplete type}}
  (void)__is_trivial(AnIncompleteType[1]); // expected-error {{incomplete type}}
  static_assert(!__is_trivial(void), "");
...
void is_trivially_copyable2()
{
  ...
  (void)__is_trivially_copyable(AnIncompleteType); // expected-error {{incomplete type}}
  (void)__is_trivially_copyable(AnIncompleteType[]); // expected-error {{incomplete type}}
  (void)__is_trivially_copyable(AnIncompleteType[1]); // expected-error {{incomplete type}}
  static_assert(!__is_trivially_copyable(void), "");
...
void is_standard_layout()
{
  ...
  (void)__is_standard_layout(AnIncompleteType); // expected-error {{incomplete type}}
  (void)__is_standard_layout(AnIncompleteType[]); // expected-error {{incomplete type}}
  (void)__is_standard_layout(AnIncompleteType[1]); // expected-error {{incomplete type}}
...
void has_trivial_default_constructor() {
  ...
  (void)__has_trivial_constructor(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_trivial_move_constructor() {
  ...
  (void)__has_trivial_move_constructor(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_trivial_copy_constructor() {
  ...
  (void)__has_trivial_copy(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_trivial_copy_assignment() {
  ...
  (void)__has_trivial_assign(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_trivial_destructor() {
  ...
  (void)__has_trivial_destructor(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_nothrow_assign() {
  ...
  (void)__has_nothrow_assign(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_nothrow_move_assign() {
  ...
  (void)__has_nothrow_move_assign(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_trivial_move_assign() {
  ...
  (void)__has_trivial_move_assign(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_nothrow_copy() {
  ...
  (void)__has_nothrow_copy(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_nothrow_constructor() {
  ...
  (void)__has_nothrow_constructor(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void has_virtual_destructor() {
  ...
  (void)__has_virtual_destructor(AnIncompleteType[]); // expected-error {{incomplete type}}
...
void is_base_of() {
  ...
  (void)__is_base_of(Empty, class_forward); // expected-error {{incomplete type 'class_forward' used in type trait expression}}
  static_assert(!__is_base_of(Base&, Derived&), "");
  ...
  (void)__is_base_of(Base, UndefinedTemp<int>); // expected-error {{implicit instantiation of undefined template 'UndefinedTemp<int>'}}
...
void trivial_checks()
{
  ...
  (void)__is_trivially_constructible(class_forward); // expected-error {{incomplete type 'class_forward' used in type trait expression}}
  ...
  (void)__is_assignable(AnIncompleteType, AnIncompleteType); // expected-error {{incomplete type}}
  static_assert(!__is_assignable(AnIncompleteType[], AnIncompleteType[]), "");
  (void)__is_assignable(AnIncompleteType[1], AnIncompleteType[1]); // expected-error {{incomplete type}}
...
void constructible_checks() {
  ...
  (void)__is_constructible(AnIncompleteType); // expected-error {{incomplete type}}
  (void)__is_nothrow_constructible(AnIncompleteType); // expected-error {{incomplete type}}
  static_assert(!__is_constructible(AnIncompleteType[]), "");
  static_assert(!__is_nothrow_constructible(AnIncompleteType[]), "");
  (void)__is_constructible(AnIncompleteType[1]); // expected-error {{incomplete type}}
  (void)__is_nothrow_constructible(AnIncompleteType[1]); // expected-error {{incomplete type}}
...
void is_trivially_constructible_test() {
  ...
  (void)__is_trivially_constructible(AnIncompleteType); // expected-error {{incomplete type}}
  static_assert(!__is_trivially_constructible(AnIncompleteType[]), "");
  (void)__is_trivially_constructible(AnIncompleteType[1]); // expected-error {{incomplete type}}
  static_assert(!__is_trivially_constructible(void), "");
...
void is_destructible_test() {
  ...
  (void)__is_destructible(AnIncompleteType); // expected-error {{incomplete type}}
  static_assert(!__is_destructible(AnIncompleteType[]), "");
  (void)__is_destructible(AnIncompleteType[1]); // expected-error {{incomplete type}}
  static_assert(!__is_destructible(void), "");
...
void is_nothrow_destructible_test() {
  ...
  (void)__is_nothrow_destructible(AnIncompleteType); // expected-error {{incomplete type}}
  static_assert(!__is_nothrow_destructible(AnIncompleteType[]), "");
  (void)__is_nothrow_destructible(AnIncompleteType[1]); // expected-error {{incomplete type}}
  static_assert(!__is_nothrow_destructible(void), "");
...
void is_trivially_destructible_test() {
  ...
  (void)__is_trivially_destructible(AnIncompleteType); // expected-error {{incomplete type}}
  static_assert(!__is_trivially_destructible(AnIncompleteType[]), "");
  (void)__is_trivially_destructible(AnIncompleteType[1]); // expected-error {{incomplete type}}
  static_assert(!__is_trivially_destructible(void), "");
