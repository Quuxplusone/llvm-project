...
TEST_CONSTEXPR_CXX20 bool test_swap_cxx20_friendly()
{
  Cxx20Friendly a = { 1, {}, 2 };
  Cxx20Friendly b = { 3, {}, 4 };
  a.strings_[1] = "1";
...
TEST_CONSTEXPR_CXX23 bool test_swap_cxx23_friendly()
{
    Cxx23Friendly a = { 1, {}, 2 };
    Cxx23Friendly b = { 3, {}, 4 };
...
int main(int, char**)
{
  test_swap_cxx20_friendly();
  test_swap_cxx23_friendly();
#if TEST_STD_VER >= 20
  static_assert(test_swap_cxx20_friendly());
#endif // TEST_STD_VER >= 20
#if TEST_STD_VER >= 23
  static_assert(test_swap_cxx23_friendly());
