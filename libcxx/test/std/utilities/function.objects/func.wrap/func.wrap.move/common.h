...
struct [[clang::trivial_abi]] TriviallyRelocatableTooLarge {
  ...
  TriviallyRelocatableTooLarge(const TriviallyRelocatableTooLarge&) = default;
  TriviallyRelocatableTooLarge& operator=(const TriviallyRelocatableTooLarge&) = default;
