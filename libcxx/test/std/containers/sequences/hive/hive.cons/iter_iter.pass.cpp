...
void basic_test()
{
  {
    int a[] = {0, 1, 2, 3};
    std::hive<int> l(cpp17_input_iterator<const int*>(a),
    ...
    int j = 0;
    for (std::hive<int>::const_iterator i = l.begin(), e = l.end(); i != e; ++i, ++j)
      assert(*i == j);
  }
  {
    int a[] = {0, 1, 2, 3};
  ...
  {
    int a[] = {0, 1, 2, 3};
    std::hive<int, min_allocator<int>> l(cpp17_input_iterator<const int*>(a),
             cpp17_input_iterator<const int*>(a + sizeof(a)/sizeof(a[0])));
    assert(l.size() == sizeof(a)/sizeof(a[0]));
    assert(std::distance(l.begin(), l.end()) == sizeof(a)/sizeof(a[0]));
    int j = 0;
    for (std::hive<int, min_allocator<int>>::const_iterator i = l.begin(), e = l.end(); i != e; ++i, ++j)
      assert(*i == j);
  }
  {
    int a[] = {0, 1, 2, 3};
...
void test_emplacable_concept() {
  ...
  int arr2[] = {1, 101, 42};
  {
    ...
    {
      std::hive<T> v(It(arr1), It(std::end(arr1)));
      auto I = v.begin();
      assert(I->value == 42);
    }
    {
      std::hive<T> v(It(arr2), It(std::end(arr2)));
      auto I = v.begin();
      assert(I->value == 1);
      ++I;
      assert(I->value == 101);
...
void test_emplacable_concept_with_alloc() {
  ...
  int arr2[] = {1, 101, 42};
  {
    ...
    std::allocator<T> a;
    {
      std::hive<T> v(It(arr1), It(std::end(arr1)), a);
      auto I = v.begin();
      assert(I->value == 42);
    }
    {
      std::hive<T> v(It(arr2), It(std::end(arr2)), a);
      auto I = v.begin();
      assert(I->value == 1);
      ++I;
      assert(I->value == 101);
