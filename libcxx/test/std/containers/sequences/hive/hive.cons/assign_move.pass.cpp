...
{
  {
    ...
    std::hive<MoveOnly, test_allocator<MoveOnly> > l2(test_allocator<MoveOnly>(5));
    std::hive<MoveOnly, test_allocator<MoveOnly> >::iterator it = l.begin();
    l2 = std::move(l);
    assert(l2 == lo);
    assert(l.empty());
  ...
  }
  {
    ...
    std::hive<MoveOnly, test_allocator<MoveOnly> > l2(test_allocator<MoveOnly>(6));
    l2 = std::move(l);
    assert(l2 == lo);
  ...
  }
  {
    ...
    std::hive<MoveOnly, other_allocator<MoveOnly> > l2(other_allocator<MoveOnly>(6));
    std::hive<MoveOnly, other_allocator<MoveOnly> >::iterator it = l.begin();
    l2 = std::move(l);
    assert(l2 == lo);
    assert(l.empty());
    assert(l2.get_allocator() == lo.get_allocator());
  ...
  }
  {
    ...
    std::hive<MoveOnly, min_allocator<MoveOnly> > l2(min_allocator<MoveOnly>{});
    std::hive<MoveOnly, min_allocator<MoveOnly> >::iterator it = l.begin();
    l2 = std::move(l);
    assert(l2 == lo);
    assert(l.empty());
    assert(l2.get_allocator() == lo.get_allocator());
