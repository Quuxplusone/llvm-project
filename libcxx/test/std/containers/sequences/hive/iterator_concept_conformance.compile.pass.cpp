...
using iterator = std::hive<int>::iterator;
using const_iterator = std::hive<int>::const_iterator;
using reverse_iterator = std::hive<int>::reverse_iterator;
using const_reverse_iterator = std::hive<int>::const_reverse_iterator;
