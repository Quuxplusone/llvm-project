...
struct test : public std::queue<T, C> {
  ...
  TEST_CONSTEXPR_CXX26 test(container_type&& container, const allocator_type& a) : base(std::move(container), a) {}
  TEST_CONSTEXPR_CXX26 test(test&& q, const allocator_type& a) : base(std::move(q), a) {}
