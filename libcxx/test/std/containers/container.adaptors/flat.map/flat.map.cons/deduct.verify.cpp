...
void test() {
  {
    ...
    std::flat_map s(v);
        // expected-error@-1{{no viable constructor or deduction guide for deduction of template arguments of 'flat_map'}}
  }
  {
  ...
  }
  {
    ...
    NotAnAllocator a;
    std::flat_map m(a); // expected-error{{no viable constructor or deduction guide for deduction of template arguments of 'flat_map'}}
  }
  {
