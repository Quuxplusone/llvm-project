...
{
  {
    ...
    assert(m.lower_bound(2) == m.begin() + 2);
    assert(m.lower_bound(3) == m.begin() + 3);
    assert(m.lower_bound(4) == m.begin() + 3);
    assert(m.lower_bound(5) == m.begin() + 5);
    assert(m.lower_bound(6) == m.begin() + 6);
    assert(m.lower_bound(7) == m.begin() + 6);
    assert(std::as_const(m).lower_bound(8) == m.begin() + 6);
  ...
  }
  {
    ...
    assert(m.lower_bound(6) == m.begin() + 3);
    assert(m.lower_bound(7) == m.begin() + 3);
