...
static const bool PmrIsTrivial =
...
static_assert(std::is_trivially_relocatable_v<std::pmr::deque<T>> == PmrIsTrivial);
static_assert(std::is_trivially_relocatable_v<std::pmr::forward_list<T>> == PmrIsTrivial);
...
static_assert(std::is_trivially_relocatable_v<std::pmr::unordered_map<K,T>> == (NotDebug && PmrIsTrivial));
static_assert(std::is_trivially_relocatable_v<std::pmr::unordered_multimap<K,T>> == (NotDebug && PmrIsTrivial));
static_assert(std::is_trivially_relocatable_v<std::pmr::unordered_multiset<K>> == (NotDebug && PmrIsTrivial));
static_assert(std::is_trivially_relocatable_v<std::pmr::unordered_set<K>> == (NotDebug && PmrIsTrivial));
static_assert(std::is_trivially_relocatable_v<std::pmr::vector<T>> == (NotDebug && PmrIsTrivial));
static_assert(std::is_trivially_relocatable_v<std::pmr::vector<bool>> == PmrIsTrivial);
...
static_assert(std::is_trivially_relocatable_v<std::pmr::cmatch> == (NotDebug && PmrIsTrivial));  // contains a vector
static_assert(std::is_trivially_relocatable_v<std::pmr::smatch> == (NotDebug && PmrIsTrivial));  // contains a vector
static_assert(std::is_trivially_relocatable_v<std::pmr::string> == (NotDebug && PmrIsTrivial));
static_assert(std::is_trivially_relocatable_v<std::pmr::string::iterator> == NotDebug);
static_assert(std::is_trivially_relocatable_v<std::pmr::wstring> == (NotDebug && PmrIsTrivial));
