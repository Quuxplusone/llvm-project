...
void f() {
  ...
  // expected-note@*:* {{because 'decay_t<int>' (aka 'int') does not satisfy 'input_or_output_iterator'}}
...
void g() {
  ...
  // expected-note@*:* {{because '__weakly_equality_comparable_with<char *, decay_t<int *> >' evaluated to false}}
