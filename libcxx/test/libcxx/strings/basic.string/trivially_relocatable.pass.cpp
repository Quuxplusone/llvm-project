...
namespace fa3 {
    ...
    struct FakePointer {
        ...
        template<class U> FakePointer(const FakePointer<U>&);
        T& operator*() const;
        T *operator->() const;
        ...
        FakePointer& operator--();
        FakePointer operator--(int);
        friend int operator-(FakePointer, FakePointer);
        friend FakePointer operator-(FakePointer, int);
        friend FakePointer operator+(FakePointer, int);
        friend FakePointer operator+(int, FakePointer);
        friend bool operator==(FakePointer, FakePointer);
        friend bool operator!=(FakePointer, FakePointer);
        static FakePointer pointer_to(T&);
    };
