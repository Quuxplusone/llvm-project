...
#include <__memory/uninitialized_relocate_backward.h> // expected-error@*:* {{use of private header from outside its module: '__memory/uninitialized_relocate_backward.h'}}
