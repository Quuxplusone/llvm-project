...
static_assert(is_tec<std::array<H*, 1>>);
static_assert(is_tec<std::complex<int>>);
static_assert(!is_tec<std::coroutine_handle<>>); // TODO
static_assert(is_tec<std::forward_list<H*>::iterator>);
static_assert(is_tec<std::forward_list<H*>::const_iterator>);
...
static_assert(is_tec<std::pair<H*, H*>>);
...
static_assert(is_tec<Adjust<std::tuple<>>>);
static_assert(is_tec<std::tuple<H*>>);
