...
#if defined(TEST_54) && !defined(_LIBCPP_HAS_NO_LOCALIZATION) && !defined(_LIBCPP_HAS_NO_FSTREAM)
#include <fstream>
#endif
...
#if defined(TEST_56) && !defined(_LIBCPP_HAS_NO_THREADS)
#include <future>
#endif
...
#if defined(TEST_63) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <iostream>
#endif
...
#if defined(TEST_64) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <istream>
#endif
...
#if defined(TEST_66) && !defined(_LIBCPP_HAS_NO_THREADS)
#include <latch>
#endif
...
#if defined(TEST_70) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <locale>
#endif
...
#if defined(TEST_71) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <locale.h>
#endif
...
#if defined(TEST_77) && !defined(_LIBCPP_HAS_NO_THREADS)
#include <mutex>
#endif
...
#if defined(TEST_87) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <regex>
#endif
...
#if defined(TEST_92) && !defined(_LIBCPP_HAS_NO_THREADS)
...
#if defined(TEST_95) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <sstream>
#endif
...
#if defined(TEST_97) && __cplusplus > 202002L && !defined(_LIBCPP_HAS_NO_THREADS)
#include <stdatomic.h>
#endif
...
#if defined(TEST_108) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <strstream>
#endif
...
#if defined(TEST_111) && !defined(_LIBCPP_HAS_NO_THREADS)
#include <thread>
#endif
...
#if defined(TEST_124) && !defined(_LIBCPP_HAS_NO_WIDE_CHARACTERS)
#include <wchar.h>
#endif
...
#if defined(TEST_125) && !defined(_LIBCPP_HAS_NO_WIDE_CHARACTERS)
#include <wctype.h>
#endif
...
#if defined(TEST_133) && !defined(_LIBCPP_HAS_NO_LOCALIZATION) && __cplusplus >= 201103L
...
#endif
// RUN: echo '%{cxx} %s %{flags} %{compile_flags} -fmodules -fcxx-modules -fmodules-cache-path=%t -fsyntax-only -DTEST_141 &' >> %t.sh
// RUN: echo 'TEST_141=$!' >> %t.sh
// RUN: echo "wait $TEST_125" >> %t.sh
#if defined(TEST_141) && __cplusplus >= 201103L
