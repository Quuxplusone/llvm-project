...
#if defined(TEST_76) && !defined(_LIBCPP_HAS_NO_THREADS)
#include <mutex>
#endif
...
#if defined(TEST_86) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <regex>
#endif
...
#if defined(TEST_91) && !defined(_LIBCPP_HAS_NO_THREADS)
...
#if defined(TEST_94) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <sstream>
#endif
...
#if defined(TEST_96) && __cplusplus > 202002L && !defined(_LIBCPP_HAS_NO_THREADS)
#include <stdatomic.h>
#endif
...
#if defined(TEST_107) && !defined(_LIBCPP_HAS_NO_LOCALIZATION)
#include <strstream>
#endif
...
#if defined(TEST_110) && !defined(_LIBCPP_HAS_NO_THREADS)
#include <thread>
#endif
...
#endif
// RUN: echo '%{cxx} %s %{flags} %{compile_flags} -fmodules -fcxx-modules -fmodules-cache-path=%t -fsyntax-only -DTEST_142 &' >> %t.sh
// RUN: echo 'TEST_142=$!' >> %t.sh
