...
void baditerator() {
  ...
  // expected-note@*:* {{because 'decltype(static_cast<::std::__decay_t<decltype((__t.begin()))>>(__t.begin()))' (aka '__forward_list_iterator<std::__forward_list_node<int, void *> *>') does not satisfy 'bidirectional_iterator'}}
