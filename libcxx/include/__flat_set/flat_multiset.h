...
flat_multiset(_InputIterator, _InputIterator, _Compare = _Compare(), _Allocator = _Allocator())
  -> flat_multiset<__iterator_value_type<_InputIterator>, _Compare,
              vector<__iterator_value_type<_InputIterator>, __allocator_traits_rebind_t<_Allocator, __iterator_value_type<_InputIterator>>>>;
...
flat_multiset(_InputIterator, _InputIterator, _Allocator)
  -> flat_multiset<__iterator_value_type<_InputIterator>, less<__iterator_value_type<_InputIterator>>,
              vector<__iterator_value_type<_InputIterator>, __allocator_traits_rebind_t<_Allocator, __iterator_value_type<_InputIterator>>>>;
