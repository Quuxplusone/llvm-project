...
#ifndef _LIBCPP___FLAT_SET_FLAT_MULTIMAP_H
#define _LIBCPP___FLAT_SET_FLAT_MULTIMAP_H
...
class __flat_multimap_iterator {
public:
  ...
  _LIBCPP_HIDE_FROM_ABI explicit __flat_multimap_iterator() = default;
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator(const __flat_multimap_iterator&) = default;
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator(__flat_multimap_iterator&&) = default;
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator& operator=(const __flat_multimap_iterator&) = default;
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator& operator=(__flat_multimap_iterator&&) = default;

  template <class _K2, class _M2>
    requires std::is_convertible_v<_K2, _KeyIt> &&
             std::is_convertible_v<_M2, _MappedIt>
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator(const __flat_multimap_iterator<_K2, _M2>& __rhs)
    : __kt_(__rhs.__key()), __vt_(__rhs.__value()) {}

  template <class _K2, class _M2>
    requires std::is_convertible_v<_K2, _KeyIt> &&
             std::is_convertible_v<_M2, _MappedIt>
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator(__flat_multimap_iterator<_K2, _M2>&& __rhs)
    : __kt_(std::move(__rhs.__key())), __vt_(std::move(__rhs.__value())) {}

  _LIBCPP_HIDE_FROM_ABI
  explicit __flat_multimap_iterator(_KeyIt __kt, _MappedIt __vt)
  ...
  friend _LIBCPP_HIDE_FROM_ABI __rvalue_reference iter_move(__flat_multimap_iterator __it) {
    return __rvalue_reference(ranges::iter_move(__it.__kt_), ranges::iter_move(__it.__vt_));
  }
#if 0 // XXX
  friend _LIBCPP_HIDE_FROM_ABI void iter_swap(__flat_multimap_iterator __it, __flat_multimap_iterator __jt) {
    ranges::swap(*__it, *__jt);
  }
#endif

  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator& operator++() { ++__kt_; ++__vt_; return *this; }
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator& operator--() { --__kt_; --__vt_; return *this; }
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator operator++(int) { auto __copy = *this; ++*this; return __copy; }
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator operator--(int) { auto __copy = *this; --*this; return __copy; }
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator& operator+=(difference_type __n) { __kt_ += __n; __vt_ += __n; return *this; }
  _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator& operator-=(difference_type __n) { __kt_ -= __n; __vt_ -= __n; return *this; }

  friend _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator operator+(__flat_multimap_iterator __it, ptrdiff_t __n) {
    __it += __n;
    return __it;
  }
  friend _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator operator-(__flat_multimap_iterator __it, ptrdiff_t __n) {
  ...
  friend _LIBCPP_HIDE_FROM_ABI __flat_multimap_iterator operator+(ptrdiff_t __n, __flat_multimap_iterator __it) {
    __it += __n;
    return __it;
  }
  friend _LIBCPP_HIDE_FROM_ABI ptrdiff_t operator-(__flat_multimap_iterator __a, __flat_multimap_iterator __b) {
    return __a.__kt_ - __b.__kt_;
  }

  friend _LIBCPP_HIDE_FROM_ABI bool
  operator==(const __flat_multimap_iterator& __a, const __flat_multimap_iterator& __b) {
    return __a.__kt_ == __b.__kt_;
  }
...
class _LIBCPP_TEMPLATE_VIS __flatmultimap_value_comp_ref {
public:
  _LIBCPP_HIDE_FROM_ABI
  explicit __flatmultimap_value_comp_ref(const _Compare& __c) : __comp_(__c) { }
...
class flat_multimap {
  ...
  static_assert(__is_cpp17_random_access_iterator<typename _MappedContainer::iterator>::value);

public:
  using iterator = __flat_multimap_iterator<typename _KeyContainer::const_iterator, typename _MappedContainer::iterator>;
  using const_iterator = __flat_multimap_iterator<typename _KeyContainer::const_iterator, typename _MappedContainer::const_iterator>;
  using key_type = _Key;
  ...
  using __mutable_iterator = __flat_multimap_iterator<typename _KeyContainer::iterator, typename _MappedContainer::iterator>;
  ...
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(const key_container_type& __keys, const mapped_container_type& __values,
           const _Alloc& __a)
    : flat_multimap(__keys, __values, key_compare(), __a) { }

  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(const key_container_type& __keys, mapped_container_type&& __values,
           const _Alloc& __a)
    : flat_multimap(__keys, std::move(__values), key_compare(), __a) { }

  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(key_container_type&& __keys, const mapped_container_type& __values,
           const _Alloc& __a)
    : flat_multimap(std::move(__keys), __values, key_compare(), __a) { }

  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(key_container_type&& __keys, mapped_container_type&& __values,
           const _Alloc& __a)
    : flat_multimap(std::move(__keys), std::move(__values), key_compare(), __a) { }
  ...
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t, key_container_type __keys,
           mapped_container_type __values,
           const key_compare& __comp = key_compare())
    : __compare_(__comp), __keys_(std::move(__keys)), __values_(std::move(__values)) {
    _LIBCPP_DEBUG_ASSERT(__keys_.size() == __values_.size(),
                         "key_cont and mapped_cont must be equal in size");
    _LIBCPP_DEBUG_ASSERT(__is_sorted(begin(), end()),
  ...
  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t __s, const key_container_type& __keys, const mapped_container_type& __values,
           const _Alloc& __a)
    : flat_multimap(__s, __keys, __values, key_compare(), __a) { }

  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t __s, const key_container_type& __keys, mapped_container_type&& __values,
           const _Alloc& __a)
    : flat_multimap(__s, __keys, std::move(__values), key_compare(), __a) { }

  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t __s, key_container_type&& __keys, const mapped_container_type& __values,
           const _Alloc& __a)
    : flat_multimap(__s, std::move(__keys), __values, key_compare(), __a) { }

  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t __s, key_container_type&& __keys, mapped_container_type&& __values,
           const _Alloc& __a)
    : flat_multimap(__s, std::move(__keys), std::move(__values), key_compare(), __a) { }

  template<class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t, const key_container_type& __keys, const mapped_container_type& __values,
           const key_compare& __comp, const _Alloc& __a)
    : __compare_(__comp),
      __keys_(std::__make_obj_using_allocator<key_container_type>(__a, __keys)),
      __values_(std::__make_obj_using_allocator<mapped_container_type>(__a, __values)) {
  ...
  template<class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t, const key_container_type& __keys, mapped_container_type&& __values,
           const key_compare& __comp, const _Alloc& __a)
    : __compare_(__comp),
      __keys_(std::__make_obj_using_allocator<key_container_type>(__a, __keys)),
      __values_(std::__make_obj_using_allocator<mapped_container_type>(__a, std::move(__values))) {
  ...
  template<class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t, key_container_type&& __keys, const mapped_container_type& __values,
           const key_compare& __comp, const _Alloc& __a)
    : __compare_(__comp),
      __keys_(std::__make_obj_using_allocator<key_container_type>(__a, std::move(__keys))),
      __values_(std::__make_obj_using_allocator<mapped_container_type>(__a, __values)) {
  ...
  template<class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t, key_container_type&& __keys, mapped_container_type&& __values,
           const key_compare& __comp, const _Alloc& __a)
    : __compare_(__comp),
      __keys_(std::__make_obj_using_allocator<key_container_type>(__a, std::move(__keys))),
      __values_(std::__make_obj_using_allocator<mapped_container_type>(__a, std::move(__values))) {
  ...
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(const flat_multimap& __fm) = default;

  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(flat_multimap&& __fm)
  ...
  _LIBCPP_HIDE_FROM_ABI
  explicit flat_multimap(const key_compare& __comp)
    : __compare_(__comp) {}
  ...
  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(const key_compare& __comp, const _Alloc& __a)
  ...
  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  explicit flat_multimap(const _Alloc& __a)
  ...
  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(const flat_multimap& __fm, const _Alloc& __a)
  ...
  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(flat_multimap&& __fm, const _Alloc& __a)
#ifndef _LIBCPP_HAS_NO_EXCEPTIONS
    try
#endif
    : __compare_(__fm.__compare_),
  ...
  template <class _InputIterator, class _Alloc>
    requires __is_cpp17_input_iterator<_InputIterator>::value &&
             ...
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(_InputIterator __first, _InputIterator __last, const key_compare& __comp, const _Alloc& __a)
    : __compare_(__comp),
      __keys_(std::__make_obj_using_allocator<key_container_type>(__a)),
      __values_(std::__make_obj_using_allocator<mapped_container_type>(__a)) {
    insert(__first, __last);
  ...
  template <class _InputIterator, class _Alloc>
    requires __is_cpp17_input_iterator<_InputIterator>::value &&
             ...
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(_InputIterator __first, _InputIterator __last, const _Alloc& __a)
    : __keys_(std::__make_obj_using_allocator<key_container_type>(__a)),
      __values_(std::__make_obj_using_allocator<mapped_container_type>(__a)) {
    insert(__first, __last);
  }
  ...
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(from_range_t, _Rp&& __r, const key_compare& __comp = key_compare())
  ...
  template <_ContainerCompatibleRange<value_type> _Rp, class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(from_range_t __fr, _Rp&& __r, const _Alloc& __a)
    : flat_multimap(__fr, std::forward<_Rp>(__r), key_compare(), __a) {}

  template <_ContainerCompatibleRange<value_type> _Rp, class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(from_range_t, _Rp&& __r, const key_compare& __comp, const _Alloc& __a)
    : flat_multimap(__comp, __a) {
    insert_range(std::forward<_Rp>(__r));
  }
  ...
  template <class _InputIterator>
    requires __is_cpp17_input_iterator<_InputIterator>::value
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t __s, _InputIterator __first, _InputIterator __last, const key_compare& __comp = key_compare())
    : __compare_(__comp) {
  ...
  template <class _InputIterator, class _Alloc>
    requires __is_cpp17_input_iterator<_InputIterator>::value &&
             ...
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t __s, _InputIterator __first, _InputIterator __last, const key_compare& __comp, const _Alloc& __a)
    : __compare_(__comp),
      __keys_(std::__make_obj_using_allocator<key_container_type>(__a)),
      __values_(std::__make_obj_using_allocator<mapped_container_type>(__a)) {
    insert(__s, __first, __last);
  ...
  template <class _InputIterator, class _Alloc>
    requires __is_cpp17_input_iterator<_InputIterator>::value &&
             ...
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t __s, _InputIterator __first, _InputIterator __last, const _Alloc& __a)
    : __keys_(std::__make_obj_using_allocator<key_container_type>(__a)),
      __values_(std::__make_obj_using_allocator<mapped_container_type>(__a)) {
    insert(__s, __first, __last);
    _LIBCPP_DEBUG_ASSERT(__is_sorted(begin(), end()),
  ...
  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(initializer_list<value_type> __il, const type_identity_t<key_compare>& __comp, const _Alloc& __a)
    : flat_multimap(__il.begin(), __il.end(), __comp, __a) {}

  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(initializer_list<value_type> __il, const _Alloc& __a)
    : flat_multimap(__il.begin(), __il.end(), __a) {}

  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t __s, initializer_list<value_type> __il,
         const key_compare& __comp = key_compare())
    : flat_multimap(__s, __il.begin(), __il.end(), __comp) {}
  ...
  flat_multimap(sorted_equivalent_t __s, initializer_list<value_type> __il,
    ...
    : flat_multimap(__s, __il.begin(), __il.end(), __comp, __a) {}

  template <class _Alloc>
    requires uses_allocator_v<key_container_type, _Alloc> &&
             uses_allocator_v<mapped_container_type, _Alloc>
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap(sorted_equivalent_t __s, initializer_list<value_type> __il, const _Alloc& __a)
    : flat_multimap(__s, __il.begin(), __il.end(), __a) { }

  _LIBCPP_HIDE_FROM_ABI
  flat_multimap& operator=(initializer_list<value_type> __il) {
    clear();
  ...
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap& operator=(const flat_multimap& __fm) {
  ...
  _LIBCPP_HIDE_FROM_ABI
  flat_multimap& operator=(flat_multimap&& __fm)
  ...
  iterator insert(const value_type& __x) {
    auto __pos = upper_bound(__x.first);
  ...
  _LIBCPP_HIDE_FROM_ABI
  iterator insert(_Pair&& __p) {
    return insert(value_type(std::forward<_Pair>(__p)));
  }

  _LIBCPP_HIDE_FROM_ABI
  iterator insert(const_iterator __pos, const value_type& __x) {
    if (__pos != end() && __value_comp_ref()(*__pos, __x)) {
      __pos = lower_bound(__x.first);
    } else if (__pos != begin() && __value_comp_ref()(__x, __pos[-1])) {
      __pos = upper_bound(__x.first);
    }
    return __insert_unchecked(__pos, __x);
  }
  ...
  void insert(_InputIterator __first, _InputIterator __last) {
    ...
    if (__n != 0) {
      ...
      ranges::inplace_merge(__mutable_begin(), __it, __end, __value_comp_ref());
    }
    __guard.__complete();
  }
  ...
  void insert(sorted_equivalent_t, _InputIterator __first, _InputIterator __last) {
    ...
    if (__n != 0) {
      auto __end = __mutable_end();
      auto __it = __end - __n;
      _LIBCPP_DEBUG_ASSERT(__is_sorted(__it, __end),
                           "sorted_equivalent expects input that is sorted");
      ranges::inplace_merge(__mutable_begin(), __it, __end, __value_comp_ref());
    }
    __guard.__complete();
  ...
  void replace(key_container_type&& __keys, mapped_container_type&& __values) {
    _LIBCPP_DEBUG_ASSERT(__keys.size() == __values.size(),
  ...
  _LIBCPP_HIDE_FROM_ABI
  void swap(flat_multimap& __y) noexcept {
    using std::swap;
  ...
  pair<iterator, iterator> equal_range(const key_type& __x) {
    ...
    auto __kfirst = std::partition_point(__keys_.begin(), __kend, [&](auto&& __e) {
      return __compare_(decltype(__e)(__e), __x);
    });
  ...
  _LIBCPP_HIDE_FROM_ABI
  friend bool operator==(const flat_multimap& __x, const flat_multimap& __y) {
    return (__x.__keys_ == __y.__keys_) && (__x.__values_ == __y.__values_);
  }

  _LIBCPP_HIDE_FROM_ABI
  friend auto operator<=>(const flat_multimap& __x, const flat_multimap& __y)
  ...
  _LIBCPP_HIDE_FROM_ABI
  friend void swap(flat_multimap& __x, flat_multimap& __y) noexcept {
    __x.swap(__y);
  }
...
private:
  ...
  void __construct_invariant() {
     ...
     // we will have no flat_multimap object and thus no invariant to restore.
     auto __begin = __mutable_begin();
     auto __end = __mutable_end();
  ...
  bool __is_sorted(const_iterator __first, const_iterator __last) const {
    return std::is_sorted(__first.__key(), __last.__key(), __comp_ref());
  }
  ...
  _LIBCPP_HIDE_FROM_ABI
  __flatmultimap_value_comp_ref<_Compare> __value_comp_ref() const {
    return __flatmultimap_value_comp_ref<_Compare>(__compare_);
  }
...
flat_multimap(_InputIterator, _InputIterator, _Compare = _Compare(), _Allocator = _Allocator())
...
template<class _InputIterator,
         ...
         class = enable_if_t<!__is_allocator<_Compare>::value>,
         class = enable_if_t<__is_allocator<_Allocator>::value>>
flat_multimap(sorted_equivalent_t, _InputIterator, _InputIterator, _Compare = _Compare(), _Allocator = _Allocator())
  -> flat_multimap<__iter_key_type<_InputIterator>, __iter_mapped_type<_InputIterator>, _Compare,
              vector<__iter_key_type<_InputIterator>, __allocator_traits_rebind_t<_Allocator, __iter_key_type<_InputIterator>>>,
              vector<__iter_mapped_type<_InputIterator>, __allocator_traits_rebind_t<_Allocator, __iter_mapped_type<_InputIterator>>>>;
...
template<class _InputIterator,
         ...
         class = enable_if_t<__is_cpp17_input_iterator<_InputIterator>::value>,
         class = enable_if_t<__is_allocator<_Allocator>::value>>
flat_multimap(_InputIterator, _InputIterator, _Allocator)
  -> flat_multimap<__iter_key_type<_InputIterator>, __iter_mapped_type<_InputIterator>, less<__iter_key_type<_InputIterator>>,
              vector<__iter_key_type<_InputIterator>, __allocator_traits_rebind_t<_Allocator, __iter_key_type<_InputIterator>>>,
              vector<__iter_mapped_type<_InputIterator>, __allocator_traits_rebind_t<_Allocator, __iter_mapped_type<_InputIterator>>>>;
...
template<class _InputIterator,
         ...
         class = enable_if_t<__is_cpp17_input_iterator<_InputIterator>::value>,
         class = enable_if_t<__is_allocator<_Allocator>::value>>
flat_multimap(sorted_equivalent_t, _InputIterator, _InputIterator, _Allocator)
  -> flat_multimap<__iter_key_type<_InputIterator>, __iter_mapped_type<_InputIterator>, less<__iter_key_type<_InputIterator>>,
              vector<__iter_key_type<_InputIterator>, __allocator_traits_rebind_t<_Allocator, __iter_key_type<_InputIterator>>>,
              vector<__iter_mapped_type<_InputIterator>, __allocator_traits_rebind_t<_Allocator, __iter_mapped_type<_InputIterator>>>>;
...
flat_multimap(from_range_t, _Rp&&, _Compare = _Compare(), _Allocator = _Allocator())
  -> flat_multimap<__range_key_type<_Rp>, __range_mapped_type<_Rp>, _Compare,
...
flat_multimap(from_range_t, _Rp&&, _Allocator)
  -> flat_multimap<__range_key_type<_Rp>, __range_mapped_type<_Rp>, less<__range_key_type<_Rp>>,
              vector<__range_key_type<_Rp>, __allocator_traits_rebind_t<_Allocator, __range_key_type<_Rp>>>,
              vector<__range_mapped_type<_Rp>, __allocator_traits_rebind_t<_Allocator, __range_mapped_type<_Rp>>>>;
...
template<class _Key, class _Tp,
         ...
         class = enable_if_t<!__is_allocator<_Compare>::value>,
         class = enable_if_t<__is_allocator<_Allocator>::value>>
flat_multimap(initializer_list<pair<_Key, _Tp>>, _Compare = _Compare(), _Allocator = _Allocator())
...
template<class _Key, class _Tp,
         ...
         class = enable_if_t<!__is_allocator<_Compare>::value>,
         class = enable_if_t<__is_allocator<_Allocator>::value>>
flat_multimap(sorted_equivalent_t, initializer_list<pair<_Key, _Tp>>, _Compare = _Compare(), _Allocator = _Allocator())
  -> flat_multimap<_Key, _Tp, _Compare,
              vector<_Key, __allocator_traits_rebind_t<_Allocator, _Key>>,
              vector<_Tp, __allocator_traits_rebind_t<_Allocator, _Tp>>>;
...
template<class _Key, class _Tp,
         class _Allocator,
         class = enable_if_t<__is_allocator<_Allocator>::value>>
flat_multimap(initializer_list<pair<_Key, _Tp>>, _Allocator)
  -> flat_multimap<_Key, _Tp, less<_Key>,
              vector<_Key, __allocator_traits_rebind_t<_Allocator, _Key>>,
              vector<_Tp, __allocator_traits_rebind_t<_Allocator, _Tp>>>;
...
template<class _Key, class _Tp,
         class _Allocator,
         class = enable_if_t<__is_allocator<_Allocator>::value>>
flat_multimap(sorted_equivalent_t, initializer_list<pair<_Key, _Tp>>, _Allocator)
  -> flat_multimap<_Key, _Tp, less<_Key>,
              vector<_Key, __allocator_traits_rebind_t<_Allocator, _Key>>,
              vector<_Tp, __allocator_traits_rebind_t<_Allocator, _Tp>>>;

template <class _Key, class _Tp, class _Compare, class _KeyContainer, class _MappedContainer, class _Alloc>
struct uses_allocator<flat_multimap<_Key, _Tp, _Compare, _KeyContainer, _MappedContainer>, _Alloc>
...
_LIBCPP_HIDE_FROM_ABI
size_t erase_if(flat_multimap<_Key, _Tp, _Compare, _KeyContainer, _MappedContainer>& __c, _Predicate __pred)
{
...
#endif // _LIBCPP___FLAT_SET_FLAT_MULTIMAP_H
