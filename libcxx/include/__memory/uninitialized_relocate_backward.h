                                ...
                                _BidirIt2 __result)
{
  ...
  static_assert(is_constructible<_Dt, _St>::value && is_destructible<__remove_cvref_t<_St> >::value,
  ...
  using _SingleMemcpy = integral_constant<bool,
    ...
    __libcpp_is_contiguous_iterator<_BidirIt1>::value &&
    __libcpp_is_contiguous_iterator<_BidirIt2>::value
  >;
