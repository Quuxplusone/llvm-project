...
class _LIBCPP_UNIQUE_PTR_TRIVIAL_ABI _LIBCPP_TRIVIALLY_RELOCATABLE_IF((__unique_ptr_be_trivially_relocatable<_Tp, _Dp>::value)) unique_ptr {
public:
...
public:
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 unique_ptr(unique_ptr&& __u) _NOEXCEPT
      : __ptr_(__u.release()),
        __deleter_(static_cast<deleter_type&&>(__u.get_deleter())) {}
  ...
  _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 unique_ptr(unique_ptr<_Up, _Ep>&& __u) _NOEXCEPT
      : __ptr_(__u.release()),
        __deleter_(static_cast<_Ep&&>(__u.get_deleter())) {}
