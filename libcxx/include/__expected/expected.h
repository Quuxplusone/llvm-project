...
template <class _Tp, class _Err>
class [[__nodiscard__]] _LIBCPP_TRIVIALLY_RELOCATABLE_IF((__expected_be_trivially_relocatable_v<_Tp, _Err>)) expected : private __expected_base<_Tp, _Err> {
...
class [[__nodiscard__]] _LIBCPP_TRIVIALLY_RELOCATABLE_IF((__expected_be_trivially_relocatable_v<void, _Err>)) expected<_Tp, _Err> : private __expected_void_base<_Err> {
