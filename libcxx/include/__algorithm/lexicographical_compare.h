...
__lexicographical_compare_iter_impl(_InputIterator1 __first1, _InputIterator1 __last1,
                                    _InputIterator2 __first2, _InputIterator2 __last2, _BinaryPredicate& __comp)
{
...
template <class _Tp,
          ...
          __enable_if_t<__desugars_to<__less_tag, _BinaryPredicate, _Tp, _Up>::value && !is_volatile<_Tp>::value &&
