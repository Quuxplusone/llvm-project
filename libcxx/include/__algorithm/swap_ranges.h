...
template <class _AlgPolicy, class _Tp, class _Up>
_LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX20 __in_out_result<_Tp*, _Up*>
...
struct __swap_ranges_impl {
  ...
  __in_out_result<_ForwardIterator1, _ForwardIterator2>
...
_LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX20 __in_out_result<_Iter1, _Iter2>
...
template <
    ...
    class _SpecialAlg =
        __specialized_algorithm<_Algorithm::__swap_ranges, __iterator_pair<_Iter1, _Sent1>, __single_iterator<_Iter2> >,
    __enable_if_t<!_SpecialAlg::__has_algorithm, int> = 0>
inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX20 __in_out_result<_Iter1, _Iter2>
__swap_ranges(_Iter1 __first1, _Sent1 __last1, _Iter2 __first2) {
  if (__libcpp_is_constant_evaluated()) {
...
swap_ranges(_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2) {
  return std::__swap_ranges<_ClassicAlgPolicy>(std::move(__first1), std::move(__last1), std::move(__first2)).__out_;
}
