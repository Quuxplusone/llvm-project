...
struct __get_pair<0>
{
    ...
    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX14
    _T1&&
    get(pair<_T1, _T2>&& __p) _NOEXCEPT {return static_cast<_T1&&>(__p.first);}

    template <class _T1, class _T2>
    static
    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX14
    const _T1&&
    get(const pair<_T1, _T2>&& __p) _NOEXCEPT {return static_cast<const _T1&&>(__p.first);}
};
...
struct __get_pair<1>
{
    ...
    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX14
    _T2&&
    get(pair<_T1, _T2>&& __p) _NOEXCEPT {return static_cast<_T2&&>(__p.second);}

    template <class _T1, class _T2>
    static
    _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX14
    const _T2&&
    get(const pair<_T1, _T2>&& __p) _NOEXCEPT {return static_cast<const _T2&&>(__p.second);}
};
